                      ...
                      <table class="table-auto w-full text-left whitespace-no-wrap">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <form id="delete_{{ $owner->id }}" method="post" action="{{ route('amin.expired-owners.destroy', ['owner' => $owner->id]) }}">
                              @csrf
                            <td class="px-4 py-3">
                              <a href='#' data-id="{{ $owner->id }}" onclick="deletePost(this)" class="text-black bg-red-200 border-0 py-2 px-4 focus:outline-none hover:bg-red-300 rounded">完全に削除</a>
                            </td>
                          </form>
                          </tr>
                          @endforeach
